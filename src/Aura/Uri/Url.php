...
class Url
{
     ...
     * authoritative, *not* the internal \Aura\Uri\Url::$_query_str. If the
    ...
    /**
     * 
     * Returns the query portion as a string.  When [[Uri::$_query | ]]
     * is non-null, uses [[php::http_build_query() | ]] on it; otherwise, 
     * returns the [[Uri::$_query_str]] property.
     * 
     ...
     * characters found in Uri::$_encode_path.
     * 
