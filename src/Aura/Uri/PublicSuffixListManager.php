...
{
    const AURA_URI_PSL_TEXT_FILE = 'public-suffix-list.txt';
    const AURA_URI_PSL_PHP_FILE = 'public-suffix-list.php';
    /**
    ...
    public function refreshPublicSuffixList()
    {
        ...
        $publicSuffixListArray = $this->parseListToArray($this->cacheDir . '/' . self::AURA_URI_PSL_TEXT_FILE);
    ...
    public function fetchListFromSource()
    {
        ...
        return $this->write(self::AURA_URI_PSL_TEXT_FILE, $publicSuffixList);
    }
    ...
    public function writePhpCache(array $publicSuffixList)
    {
        ...
        return $this->write(self::AURA_URI_PSL_PHP_FILE, $data);
    }
    ...
    {
        if ($this->list == null) {
            $list = include $this->cacheDir . '/' . self::AURA_URI_PSL_PHP_FILE;
